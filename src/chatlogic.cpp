...
//                            _edges.push_back(edge.get());
    ...
    ChatBot initChatBot("../images/chatbot.png");
    initChatBot.SetChatLogicHandle(this);
    _chatBot = &initChatBot;
    initChatBot.SetRootNode(rootNode);
    rootNode->MoveChatbotHere(std::move(initChatBot));
